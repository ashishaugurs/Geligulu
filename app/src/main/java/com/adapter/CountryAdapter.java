...
import com.geligulu.MainActivity;
import com.geligulu.R;
import com.model.Model_country;
...
public class CountryAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        tv_state.setTypeface(CommonUtils.setFontTextHeader(context));

        if(al_country.get(i).getStr_country().equalsIgnoreCase("Contacts")
                || al_country.get(i).getStr_country().equalsIgnoreCase("applications"))
        {

            tv_state.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
            tv_state.setText(al_country.get(i).getStr_country());
        }else{
            tv_state.setCompoundDrawablesWithIntrinsicBounds(0, 0,R.mipmap.caret_down, 0);
            tv_state.setText(al_country.get(i).getStr_country());
        }
    ...
    public View getChildView(final int i, final int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        TextView tv_state = (TextView)view.findViewById(R.id.tv_name);
        tv_state.setTypeface(CommonUtils.setFontFTRABK(context));
